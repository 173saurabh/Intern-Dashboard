...
<html lang="en">
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><h4 style="color:whitesmoke">Student Dashboard</h4></a>
 ...
 <!--         <div class="search-field d-none d-xl-block">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <!--       <li class="nav-item  dropdown d-none d-md-block">
                ...
                <?php  if (isset($_SESSION['username'])) : 
                  ...
                  <p class="mb-1 text-black" id="Student"> Welcome <strong><?php  echo $fullname;?></strong></p>
                  <?php endif ?>
                </div>
                     </a>
                     <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                       <div class="p-3 text-center bg-primary">
                        <img class="img-avatar img-avatar48 img-avatar-thumb" src="../../assets/images/faces/face28.png" alt="">                       </div>
                        <div class="p-2">
      ...
      <!--      <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../tables/course_register.php">
                <span class="icon-bg"><i class="mdi mdi-table-large menu-icon"></i></span>
...
// $(document).ready(function () {
 ...
 // });
  ...
  success: function (response) {
          ...
          document.querySelector('#Student').innerHTML = response[0].firstname;
    }
  });    
