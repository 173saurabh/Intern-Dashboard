    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><h4 style="color:whitesmoke">ADMIN DASHBOARD</h4></a>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <!--    <div class="btn-group bg-white p-3" role="group" aria-label="Basic example">
                  ...
                  <button style="background-color: rgb(145, 142, 138); color: white;" class="btn   p-3 d-flex align-items-center" type="button" id="dropdownMenuButton1"> <i class="mdi mdi-calendar mr-1"></i>24 Mar 2019 - 24 Mar 2019 </button>
              ...
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" id="home-tab" data-toggle="tab" href="#" role="tab" aria-selected="true">Current Projects</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business-1" role="tab" aria-selected="false">Completed Projects</a>
                    </li>
                  </ul>
                </div>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Shopping Website</h5>
                            <h2 class="mb-4 text-dark font-weight-bold">75% Completed</h2>
                            <div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-lightbulb icon-md absolute-center text-dark"></i></div>
                            <p class="mt-4 mb-0">Started on:</p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark">08-04-2021</h3>
                            <p class="mt-4 mb-0">Ends on:</p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark">30-06-2021</h3>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Kayik</h5>
                            <h2 class="mb-4 text-dark font-weight-bold">85% Completed</h2>
                            <div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-account-circle icon-md absolute-center text-dark"></i></div>
                            <p class="mt-4 mb-0">Started on:</p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark">10-04-2021</h3>
                            <p class="mt-4 mb-0">Ends on:</p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark">24-06-2021</h3>
                          </div>
                        </div>
                      </div>
